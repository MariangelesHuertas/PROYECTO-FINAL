...
describe('TiposAlertasController', () => {
  let controller: TiposAlertasController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<TiposAlertasController>(TiposAlertasController);
    service = module.get<TiposAlertasService>(TiposAlertasService);

  });


  const name = "TiposAlerta-ctrl"
